...
<html>
<head>
<title>Christi's Web Cam Examples</title>
...
<header>
  <h1><a href="index.php"><i class="logo fa fa-video-camera"></i>Christi's Web Cam Examples</a></h1>
  <nav id="cssmenu">
  <ul>
...
<!-- START LEFT COL -->
<section>
 <h2 class="pageID">Two Webcams</h2>
    
<!-- END top Include File -->          
<div class='embed-container'><iframe src='https://www.youtube.com/embed/m9VO7X_q9nw' frameborder='0' allowfullscreen></iframe></div>
...
<!-- START Footer -->
    <footer>
      <p><small>&copy; 2017 - 2018 by <a href="contact.php">Christi Del Nagro</a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
<!-- END Footer --> 
